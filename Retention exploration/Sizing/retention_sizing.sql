...
funnel as (
    select 
        ...
        sum(case when custom_price_filter = 1 and sales_model_filter = 1 and mkt_segment_filter = 1 and billing_filter = 1 and filter_sku = 1 and currency_filter = 1 and account_age_filter = 1 and days_renew_filter = 1 and arr_filter = 1 and login_filter = 1 then 1 else 0 end) login_filter,
        sum(case when custom_price_filter = 1 and sales_model_filter = 1 and mkt_segment_filter = 1 and billing_filter = 1 and filter_sku = 1 and currency_filter = 1 and account_age_filter = 1 and days_renew_filter = 1 and arr_filter = 1 and login_filter = 1 and proba_filter = 1 then 1 else 0 end) proba_filter,
